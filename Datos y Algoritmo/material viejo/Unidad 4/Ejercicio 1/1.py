...
if __name__=="__main__":
    ...
    numero=a.search(11)
    if numero!=None:
        print("Se encontro el numero [%d]"%(numero.getValue()))
    else:
        print("No se encontro")

    a.recover()
    level=a.levelNode(11)
    if level!=-1:
        print("Nivel del Nodo: [%d]"%(level))
    else:
        print("Error no existe el elemento")
    ...
    maximaAltura=a.maxHeight()
    print("La Altura es [%d]"%(maximaAltura))
