...
class ListSequentialSort:
    ...
    def __init__(self,size):
        self.__items=np.empty(size,dtype=Designaciones)
        self.__head=0
        self.__size=size
    ...
    def insert(self,item:Designaciones):
        pos=0
        while pos<self.__head and self.__items[pos].getAño()<item.getAño():
            pos+=1
    ...
    def watch(self):
        for i in self:
            print("Año:[%s] Materia:[%s] Cargo:[%s]"%(i.getAño(),i.getMateria(),i.getCargo()))
